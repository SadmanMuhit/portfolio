              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a 
                    key={i} 
                    href="#" 
                    className="p-3 rounded-full glass hover:text-primary transition-all hover:scale-110"
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                {skills.map((skill, i) => (
                  <motion.div
                    ...
                    className="group relative p-[1px] rounded-2xl overflow-hidden transition-all duration-500"
                  >
